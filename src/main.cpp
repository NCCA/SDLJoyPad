    ...
    while ( SDL_PollEvent(&event) )
    {
      switch (event.type)
      {
        ...
        case SDL_KEYDOWN:
          switch( event.key.keysym.sym )
          {
            ...
            break;
            case SDLK_z :  game.fireLeft(0.5); break;
            case SDLK_x :  game.fireRight(0.5); break;

            case SDLK_UP : yupdate=UPDATE; break;
            case SDLK_DOWN : yupdate=-UPDATE; break;
            case SDLK_LEFT : xupdate=-UPDATE; break;
            case SDLK_RIGHT : xupdate=UPDATE; break;
      ...
      case SDL_KEYUP:
        ...
        switch( event.key.keysym.sym )
        {
          ...
          case SDLK_UP : yupdate=0; break;
          case SDLK_DOWN : yupdate=0; break;
          case SDLK_LEFT : xupdate=0; break;
          case SDLK_RIGHT : xupdate=0; break;
        }
